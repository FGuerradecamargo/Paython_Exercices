...
#  calculate the monthly installment (cannot be more tha 30% of the wage)
...
time = int(input('Enter the number of the years for payment: '))
installment = house_price / (time * 12)
